...
const RESUME = "/sujith-rathod-resume.pdf";
        ...
        >
            <div className="reveal flex flex-col items-center lg:items-start">
                ...
                <div className="mt-6 lg:mt-8 flex flex-wrap items-center justify-center lg:justify-start gap-3">
                    ...
                    {/* One control, two actions: open it to read, or pull the file down */}
                    <div className="btn-split">
                        ...
                        <span className="btn-split__rule" aria-hidden="true" />

                        <a
                            href={RESUME}
                            download="Sujith-Rathod-Resume.pdf"
                            className="btn-split__icon"
